...
function inputValidering(){
    ...
    if(antallInput>=1){
        ...
        $("#feilAntallBilletter").html("Velg hvor mange billetter du vil kjøppe");
    }
...
function kjopBillett() {
    ...
    if (utMeldingFornavn !== "feil" && utMeldingEtternavn !== "feil" && utMeldingEpost !== "feil" && utMeldingtlfNr !== "feil") {
